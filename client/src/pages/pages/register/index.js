...
import { signup, isAuthenticated } from '../../../../actions/authentication'
        ...
        <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <form noValidate autoComplete='off' onSubmit={handleSubmit}>
            <TextField
              ...
              sx={{ marginBottom: 4 }}
            />
            <TextField fullWidth value={email} onChange={handleChange('email')} type='email' label='Email' sx={{ marginBottom: 4 }} />
